...
namespace Codecool.CodecoolShop
{
    public class Startup
    {
        ...
        public static void SetupInMemoryDatabases()
        {
            ...
            Supplier greekHandMadeCo = new Supplier { Name = "Greek Hand Made Company", Description = "Hand crafted items directly from Greece." };
            supplierDataStore.Add(greekHandMadeCo);
            Supplier fancyDressCentral = new Supplier { Name = "Fancy Dress Central", Description = "Fancy dresses for all your parties." };
            supplierDataStore.Add(fancyDressCentral);
            Supplier ancientTimes = new Supplier { Name = "Ancient Times GmbH", Description = "Finest weapons from Alemania." };
            supplierDataStore.Add(ancientTimes);
            ...
            productDataStore.Add(new Product { Name = "Persian Ship", DefaultPrice = 49.9m, Image = "ship-persian.png", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = ship, Supplier = greekHandMadeCo });
            productDataStore.Add(new Product { Name = "Spartan Army Bowie Knife", DefaultPrice = 49.9m, Image = "spartan-army-bowie-knife.jpg", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = sword, Supplier = greekHandMadeCo });
            productDataStore.Add(new Product { Name = "Xiphos", DefaultPrice = 49.9m, Image = "xiphos.png", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = sword, Supplier = ancientTimes });
            ...
            productDataStore.Add(new Product { Name = "Helmet", DefaultPrice = 49.9m, Image = "greekHelmet.jpg", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = helmet, Supplier = greekHandMadeCo });
            productDataStore.Add(new Product { Name = "Helmet", DefaultPrice = 49.9m, Image = "greekHelmet2.jpg", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = helmet, Supplier = amazon });
            productDataStore.Add(new Product { Name = "Helmet", DefaultPrice = 49.9m, Image = "greekHelmet3.jpg", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = helmet, Supplier = amazon });
            ...
            productDataStore.Add(new Product { Name = "Sword", DefaultPrice = 49.9m, Image = "sword2.jpg", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = sword, Supplier = ancientTimes });
            productDataStore.Add(new Product { Name = "Sword", DefaultPrice = 49.9m, Image = "sword3.jpg", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = sword, Supplier = ancientTimes });
            ...
            productDataStore.Add(new Product { Name = "Ship", DefaultPrice = 49.9m, Image = "ship3.jpg", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = ship, Supplier = greekHandMadeCo });
            ...
            productDataStore.Add(new Product { Name = "Spear", DefaultPrice = 49.9m, Image = "spear2.jpg", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = spear, Supplier = ancientTimes });
            ...
            productDataStore.Add(new Product { Name = "Spear", DefaultPrice = 49.9m, Image = "spear4.jpg", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = spear, Supplier = greekHandMadeCo });
            productDataStore.Add(new Product { Name = "Spear", DefaultPrice = 49.9m, Image = "spear5.jpg", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = spear, Supplier = ancientTimes });
            ...
            productDataStore.Add(new Product { Name = "Mace", DefaultPrice = 49.9m, Image = "mace2.jpg", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = mace, Supplier = greekHandMadeCo });
            productDataStore.Add(new Product { Name = "Mace", DefaultPrice = 49.9m, Image = "mace3.jpg", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = mace, Supplier = ancientTimes });
            productDataStore.Add(new Product { Name = "Axe", DefaultPrice = 49.9m, Image = "axe.jpg", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = axe, Supplier = ancientTimes });
            ...
            productDataStore.Add(new Product { Name = "Shield", DefaultPrice = 49.9m, Image = "shield3.jpg", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = shield, Supplier = ancientTimes });
            ...
            productDataStore.Add(new Product { Name = "Armour", DefaultPrice = 49.9m, Image = "armour.jpg", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = armour, Supplier = greekHandMadeCo });
            ...
            productDataStore.Add(new Product { Name = "Helmet", DefaultPrice = 49.9m, Image = "helmet.jpg", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = helmet, Supplier = greekHandMadeCo });
            ...
            productDataStore.Add(new Product { Name = "Armour", DefaultPrice = 49.9m, Image = "armour2.jpg", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = armour, Supplier = ancientTimes });
            productDataStore.Add(new Product { Name = "Armour", DefaultPrice = 49.9m, Image = "armour3.jpg", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = armour, Supplier = greekHandMadeCo });
            ...
            productDataStore.Add(new Product { Name = "Trident", DefaultPrice = 49.9m, Image = "trident2.jpg", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = trident, Supplier = greekHandMadeCo });
            productDataStore.Add(new Product { Name = "Trident", DefaultPrice = 49.9m, Image = "trident3.jpg", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = trident, Supplier = ancientTimes });
        }
    }
}
