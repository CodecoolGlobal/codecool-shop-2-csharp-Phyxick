...
namespace Codecool.CodecoolShop
{
    public class Startup
    {
        ...
        private void SetupInMemoryDatabases()
        {
            ...
            ProductCategory phone = new ProductCategory {Name = "Phone", Department = "Phone", Description = "Some description." };
            ProductCategory laptop = new ProductCategory {Name = "Laptop", Department = "Laptop", Description = "Some description." };
