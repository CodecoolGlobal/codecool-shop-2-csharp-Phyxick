...
namespace Codecool.CodecoolShop
{
    public class Startup
    {
        ...
        private void SetupInMemoryDatabases()
        {
            ...
            productDataStore.Add(new Product { Name = "Helmet", DefaultPrice = 49.9m, Image = "greekHelmet.jpg", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = helmet, Supplier = amazon });
